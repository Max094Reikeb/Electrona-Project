...
public class XPGenerator extends Block {
    ...
    public void appendHoverText(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
        ...
        list.add(new TranslationTextComponent("block.electrona.xp_generator.desc1"));
        list.add(new TranslationTextComponent("block.electrona.xp_generator.desc2"));
        list.add(new TranslationTextComponent("block.electrona.xp_generator.desc3"));
    }
