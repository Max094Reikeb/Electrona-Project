...
public class BiomassGenerator extends Block {
    ...
    public void appendHoverText(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
        ...
        list.add(new TranslationTextComponent("block.electrona.biomass_generator.desc1"));
        list.add(new TranslationTextComponent("block.electrona.biomass_generator.desc2"));
    }
